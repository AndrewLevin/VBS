...
parser.add_option('--signallabel',dest='signallabel',default='clone1')
parser.add_option('--signalhistname',dest='signalhistname')
...
xpositions = [0.20,0.20,0.20,0.20,0.20,0.20,0.20,0.20,0.20]
...
wpwpjjewk = hist_file.Get(options.signalhistname).Clone()
...
j=0
draw_legend(xpositions[j],0.84 - ypositions[j]*yoffset,wpwpjjewk,options.signallabel,"l")
j=j+1
