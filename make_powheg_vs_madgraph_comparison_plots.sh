...
output_dir_wmwm=/afs/cern.ch/user/a/anlevin/www/VBS/${date}/wmwm/
output_dir_wpwp=/afs/cern.ch/user/a/anlevin/www/VBS/${date}/wpwp/
...
python2.6 plot_lhe_distributions.py "output_distributions_madgraph_wmwm.root" "output_distributions_powheg_wmwm.root" 1 1 1 1 1 "dilepton_mass" "dilepton_mass" "m_{ll} (GeV)" "madgraph" "powheg" "${output_dir_wmwm}mg_powheg_mll.png" 0
...
python2.6 plot_lhe_distributions.py "output_distributions_madgraph_wpwp.root" "output_distributions_powheg_wpwp.root" 1 1 1 1 1 "dilepton_mass" "dilepton_mass" "m_{ll} (GeV)" "madgraph" "powheg" "${output_dir_wpwp}mg_powheg_mll.png" 0
